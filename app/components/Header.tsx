    ...
    return (
        <>
            ...
            <div className="fixed top-0  left-0 right-0 z-50">
                ...
                <header className={`w-full transition-all duration-300 ${scrolled || isMenuOpen ? 'bg-white shadow-md' : 'bg-white/90'}`}>
                    <div className="max-w-7xl mx-auto px-4 py-1 pb-5 lg:pb-1 sm:px-6 lg:px-8">
