...
const ExploreCard = ({ id, imgUrl, title, description, industry, impact, slug, index, active, handleClick }: ExploreCardProps) => {
  const CardContent = () => (
    <motion.div
          ...
          {slug && (
            <div className="mt-[16px]">
              <Link href={`/case-studies/${slug}`}>
                <button className="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 px-6 rounded-lg transition-colors duration-300 flex items-center justify-center gap-2">
