...
const QuoraSection = () => {
  return (
    <section className="relative py-20 flex flex-col items-center justify-center overflow-hidden min-h-[600px]">
      ...
      <motion.h2
        ...
        viewport={{ once: true }}
        className="text-4xl md:text-5xl font-black text-[#b92b27] mb-4 text-center z-10"
      >
        Ask Us On Quora
      </motion.h2>
      <motion.p
        ...
        viewport={{ once: true }}
        className="text-lg text-gray-700 max-w-xl text-center mb-10 z-10"
      >
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.97 }}
        className="inline-flex items-center gap-3 px-8 py-4 rounded-full bg-[#b92b27] text-white font-bold text-lg shadow-lg transition-colors duration-300 hover:bg-[#a3201a] focus:outline-none focus:ring-4 focus:ring-[#b92b27]/30 z-10"
      >
